...
public class CR009RelatedEventAndDormantStatusRuleTest {
    TestDataHelper testDataHelper;

    List<ProductArrangement> arrangementList;

    CR009RelatedEventAndDormantStatusRule rule;
    ...
    @Before
    public void setUp() {
        rule = new CR009RelatedEventAndDormantStatusRule();
    ...
    @Test
    public void testCR009IsSuccessful() throws Exception {
        ruleDto.setRule("CR009");
        ruleDataHolder.setRule(ruleDto.getRule());
    ...
    @Test
    public void testCR009IsFail() throws Exception {
