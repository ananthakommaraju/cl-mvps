...
public class CR008RelatedEventAndDormantStatusRuleTest {

    TestDataHelper testDataHelper;

    List<ProductArrangement> arrangementList;

    CR008RelatedEventAndDormantStatusRule rule;
    ...
    @Before
    public void setUp() {
        rule = new CR008RelatedEventAndDormantStatusRule();
    ...
    @Test
    public void testCR008IsSuccessful() throws Exception {
        ruleDto.setRule("CR008");
        ruleDataHolder.setRule(ruleDto.getRule());
    ...
    @Test
    public void testCR008IsFail() throws Exception {
