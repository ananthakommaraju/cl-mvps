...
public class Story42DeciReturnEligibilityBasedOnRelatedEventAndDormantStatusRuleTest extends AbstractDeciJBehaveTestBase {
    ...
    public void givenThereIsRuleCR004WithThreshold37AndChannelIsLTB() {
        ...
        mockScenarioHelperWZ.expectRefInstructionRulesPrdData("P_LOAN_STP", "GR001", "Customer not eligible for personal loan ", "CR004", "GRP", "Customer does not have an existing product with the Pay bill", "37", "AGT", "LTB", new BigDecimal("1"));
    ...
    @Then("Reason description for rule CR004 and threshold 37")
    public void thenReasonDescriptionForRuleCR004AndThreshold37() {
        assertEquals("Customer doesn't have an existing product with the 37 event enabled", response.getProductEligibilityDetails()
                .get(0)
                .getDeclineReasons()
                .get(0)
                .getDescription());
