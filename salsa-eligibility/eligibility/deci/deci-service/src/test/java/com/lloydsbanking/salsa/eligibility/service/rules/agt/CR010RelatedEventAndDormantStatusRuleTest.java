...
public class CR010RelatedEventAndDormantStatusRuleTest {

    TestDataHelper testDataHelper;

    List<ProductArrangement> arrangementList;

    CR010RelatedEventAndDormantStatusRule rule;
    ...
    @Before
    public void setUp() {
        rule = new CR010RelatedEventAndDormantStatusRule();
    ...
    @Test
    public void testCR010IsSuccessful() throws Exception {
        ruleDto.setRule("CR010");
        ruleDataHolder.setRule(ruleDto.getRule());
    ...
    @Test
    public void testCR010IsFail() throws Exception {
