...
Scenario: 1. Return eligibility status based on rule CR037
...
And Reason description for rule CR037 and threshold 37

Scenario: 2. Return eligibility status based on rule CR037
...
Scenario: 3. Return eligibility status based on rule CR037
