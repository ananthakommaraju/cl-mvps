...
Given customer is not younger than 18 years of age and channel is STL
And he is applying for personal loans
When the UI calls DECI with valid request
Then DECI evaluates eligibility to true
...
Given customer is younger than 18 years of age and channel is STL
And he is applying for personal loans
When the UI calls DECI with valid request
Then DECI evaluates eligibility to false for personal loans and returns error condition for age younger than threshold

Scenario: 5. Determine eligible customer instruction service evaluates eligibility true for customer age
older than threshold
...
Scenario: 6. Determine eligible customer instruction service evaluates eligibility false for customer age
younger than threshold
