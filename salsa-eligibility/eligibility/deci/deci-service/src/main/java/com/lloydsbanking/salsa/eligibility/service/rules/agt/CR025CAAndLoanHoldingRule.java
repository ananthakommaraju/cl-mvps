...
public class CR025CAAndLoanHoldingRule implements AGTEligibilityRule {
    ...
    public EligibilityDecision evaluate(RuleDataHolder ruleDataHolder) throws EligibilityException {
        ...
        List<ProductPartyData> productPartyDatas = null;
        try {
        ...
        if ((hasFEPSLoan || hasLoggedInChannelLoan) && !hasCurrentAccount) {
            return new EligibilityDecision(DeclineReasons.CR025_DECLINE_REASON);
        }
