...
public class CR002CustomerAgeRule implements CSTEligibilityRule {

    private static final Logger LOGGER = Logger.getLogger(CR002CustomerAgeRule.class);
    ...
    public EligibilityDecision evaluate(RuleDataHolder ruleDataHolder, XMLGregorianCalendar birthDate, String sortCode, String customerId) {
        ...
        if (age < ageThreshold) {
            return new EligibilityDecision("Customer's age is null or  Customer cannot be younger than " + threshold + " years.");
        }
