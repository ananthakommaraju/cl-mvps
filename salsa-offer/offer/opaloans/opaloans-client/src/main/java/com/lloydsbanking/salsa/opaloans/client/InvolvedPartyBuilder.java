...
public class InvolvedPartyBuilder {
    ...
    public InvolvedPartyBuilder existingSortCode(String sortCode) {
        involvedParty.setExistingSortCode(sortCode);
        return this;
    }
    public InvolvedPartyBuilder existingAccountNumber(String accountnumber) {
        involvedParty.setExistingAccountNumber(accountnumber);
        return this;
    }
