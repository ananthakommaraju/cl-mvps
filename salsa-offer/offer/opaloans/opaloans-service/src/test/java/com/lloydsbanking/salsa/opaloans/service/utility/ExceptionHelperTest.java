package com.lloydsbanking.salsa.opaloans.service.utility;
...
public class ExceptionHelperTest {
    ...
    public void setUp() {
        ...
        responseHeader = new RequestToResponseHeaderConverter().convert(testDataHelper.createOpaLoansRequestHeader("IBL"));
    }
