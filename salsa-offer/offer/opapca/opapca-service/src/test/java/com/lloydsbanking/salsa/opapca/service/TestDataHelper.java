...
import com.lloydsbanking.salsa.offer.createinvolvedparty.convert.EmployerAddressDataFactory;
import com.lloydsbanking.salsa.offer.createinvolvedparty.convert.PhoneUpdDataFactory;
import com.lloydsbanking.salsa.offer.createinvolvedparty.convert.StructuredAddressFactory;
...
import com.lloydsbanking.salsa.opapca.client.*;
...
public class TestDataHelper {
    ...
    ApplicationStatus applicationStatus1 = new ApplicationStatus("1001", "Initialised");
    ApplicationStatus applicationStatus2 = new ApplicationStatus("1002", "Approved");
    ApplicationStatus applicationStatus3 = new ApplicationStatus("1003", "Referred");
    ApplicationStatus applicationStatus4 = new ApplicationStatus("1004", "Declined");
    ApplicationStatus applicationStatus5 = new ApplicationStatus("1005", "Not Scored");
    ApplicationStatus applicationStatus6 = new ApplicationStatus("1014", "Awaiting Related Appplication Fulfilment");
    ApplicationStatus applicationStatus7 = new ApplicationStatus("1007", "Awaiting Manual IDV");
    ...
    ApplicationFeatureTypes applicationFeatureTypes = new ApplicationFeatureTypes("BENPA","BenefitPayments");
    ApplicationFeatureTypes applicationFeatureTypes1 = new ApplicationFeatureTypes("CHQBK","ChequeBook");

    Demographics demographics1 = new Demographics("1001", "Source Of Funding");
    Demographics demographics2 = new Demographics("1002", "Net Income");
    Demographics demographics3 = new Demographics("1003", "Other Income");
    Demographics demographics4 = new Demographics("1004", "Mortgage/Rent amount");
    Demographics demographics5 = new Demographics("1005", "Loan Repayment Amount");
    Demographics demographics6 = new Demographics("1006", "Savings amount");
    Demographics demographics7 = new Demographics("1007", "Number of Dependents");

    DemographicValues demographicValues1 = new DemographicValues(1l, demographics1, "101", "Cash");
    DemographicValues demographicValues2 = new DemographicValues(4l, demographics2, "104", "Monthly");
    DemographicValues demographicValues3 = new DemographicValues(5l, demographics3, "105", "Total");
    DemographicValues demographicValues4 = new DemographicValues(6l, demographics4, "106", "Monthly");
    DemographicValues demographicValues5 = new DemographicValues(7l, demographics5, "107", "Monthly");
    DemographicValues demographicValues6 = new DemographicValues(8l, demographics6, "108", "Total");
    DemographicValues demographicValues7 = new DemographicValues(9l, demographics7, "109", "Under 18");
    ...
    ParameterGroups parameterGroups9=new ParameterGroups("SIRA","SIRA Total Rule Score");
    ParameterGroups parameterGroups10=new ParameterGroups("SIRA","SIRA decision");
    ...
    ApplicationParameters applicationParameters12 = new ApplicationParameters("100001", parameterGroups2, "ASM decline code");
    ApplicationParameters applicationParameters13 = new ApplicationParameters("100007", parameterGroups2, "ASM REFER");
    ApplicationParameters applicationParameters14 = new ApplicationParameters("100038", parameterGroups2, "Credit Limit");
    ApplicationParameters applicationParameters15 = new ApplicationParameters("100016", parameterGroups2, "Not sure");
    ApplicationParameters applicationParameters16 = new ApplicationParameters("100009", parameterGroups2, "Not sure");
    ApplicationParameters applicationParameters17 = new ApplicationParameters("100039", parameterGroups1, "Auth Customer");
    ApplicationParameters applicationParameters18 = new ApplicationParameters("100045", parameterGroups2, "Credit Limit Amount");
    ApplicationParameters applicationParameters21 = new ApplicationParameters("100063", parameterGroups10, "SIRA Total Rule Score");
    ApplicationParameters applicationParameters20 = new ApplicationParameters("100062", parameterGroups9, "SIRA Result Status");
    ApplicationParameters applicationParameters19 = new ApplicationParameters("100060", parameterGroups2, "OVERDRAFT_RISK_CODEt");
    ...
    ApplicationPartyRoles roles4 = new ApplicationPartyRoles("0005", "Secondary Party");

    KycStatus status = new KycStatus();
    KycStatus status1 = new KycStatus("N/A");
    KycStatus status2 = new KycStatus("1001");
    // KycStatus status4 = new KycStatus();
    KycStatus status5 = new KycStatus();
    KycStatus status3 = new KycStatus("ACCEPT");
    KycStatus status4 = new KycStatus("REFER");
    ...
    public OfferProductArrangementRequest generateOfferProductArrangementPCARequest(String channelId) {
        RequestHeader header = createOpaPcaRequestHeader(channelId);
        OfferProductArrangementRequest request = new OpaPcaRequestBuilder().requestHeader(header).depositArrangement(createDepositArrangement()).build();
        return request;
    }

    public List<AffiliateDetails> createAffiliateDetailsListForUpdate() {
        List<AffiliateDetails> affiliateDetailsList = createAffiliateDetailsList();
    ...
    public DetermineEligibleCustomerInstructionsResponse eligibilityResponseForFailue() {
        ...
        reasonCode.setDescription("Customer's age is null or  Customer cannot be younger than 200 years.");
    ...
    public Individual createIsPlayedByWithourStayDuration() {
        DatatypeFactory datatypeFactory = null;
        try {
            datatypeFactory = DatatypeFactory.newInstance();
        } catch (DatatypeConfigurationException e) {
    ...
    public F336Resp createF336ResponseWithValidProductHoldings(int productOneGroupId, int productTwoGroupId) {
        F336Resp f336Resp = new F336Resp();
        f336Resp.setAdditionalDataIn(0);
        f336Resp.setF336Result(createF336Result());
        List<ProductPartyData> productPartyData = new ArrayList<>();
    ...
    public F061Resp createF061Resp(int reasonCode) {
        ...
        structuredAddress.setSubBuildingNm("23");
        structuredAddress.setInPostCd("9EQ");
        structuredAddress.setOutPostCd("SE1");
        structuredAddress.setAddressCountyNm("London");
    ...
    public F062Req createF062ReqWhenBfpoNotPresent(String arrangementType, Customer primaryInvolvedParty, RequestHeader header, boolean marketingPref, String addressStrength, String identityStrength) throws OfferProductArrangementInternalServiceErrorMsg, ParseException, OfferProductArrangementDataNotAvailableErrorMsg {

        return convertWhenBfpoNotPresent(arrangementType, primaryInvolvedParty, header, addressStrength, identityStrength, marketingPref);
        /*}*/
       /* catch (Exception e) {
            LOGGER.error("Returning InternalServiceError while creating OCIS F062 : ", e);
            throw exceptionUtility.internalServiceError(INTERNAL_SERVICE_ERROR_CODE, e.getMessage());
    ...
    public void createPamReferenceData() {
        ...
        appStatusDao.save(applicationStatus6);
        appStatusDao.save(applicationStatus7);
        ...
        demographicsDao.save(demographics1);
        demographicsDao.save(demographics2);
        demographicsDao.save(demographics3);
        demographicsDao.save(demographics4);
        demographicsDao.save(demographics5);
        demographicsDao.save(demographics6);
        demographicsDao.save(demographics7);
        demographicsDao.findAll();
        demographicValuesDao.save(demographicValues1);
        demographicValuesDao.save(demographicValues2);
        demographicValuesDao.save(demographicValues3);
        demographicValuesDao.save(demographicValues4);
        demographicValuesDao.save(demographicValues5);
        demographicValuesDao.save(demographicValues6);
        demographicValuesDao.save(demographicValues7);
        ...
        parameterGroupsDao.save(parameterGroups10);
        ...
        approvalStatusDao.save(new ApprovalStatus("001"));
        promotionPartiesDao.save(createPromotionPartyList());

        status.setCode("DECLINE");
        status.setDescription("DECLINE");
        status4.setCode("ACCEPT");
        status4.setDescription("ACCEPT");
        status5.setCode("REFER");
        status5.setDescription("REFER");
        ...
        kycStatus.setCode("1");
        kycStatus.setDescription("Approve");
        ...
        //abandonDeclineReasonDao.save(abandonDeclineReasons);
        ...
        applicationRelationshipTypesDao.findAll();
    ...
    public DetermineEligibleCustomerInstructionsRequest eligibilityRequestForDownsell() {
        DetermineEligibleCustomerInstructionsRequest eligibilityRequest = new DetermineEligibleCustomerInstructionsRequest();

        String candidateInstruction1 = "id1";
        String candidateInstruction2 = "id4";
        String candidateInstruction3 = "id4";
        String candidateInstruction4 = "id1";


        eligibilityRequest.getCandidateInstructions().add(candidateInstruction1);
        eligibilityRequest.getCandidateInstructions().add(candidateInstruction2);
        eligibilityRequest.getCandidateInstructions().add(candidateInstruction3);
        eligibilityRequest.getCandidateInstructions().add(candidateInstruction4);


        eligibilityRequest.setArrangementType("CA");

        return eligibilityRequest;

    }

    public DetermineEligibleCustomerInstructionsRequest eligibilityRequestForUpsell() {
        DetermineEligibleCustomerInstructionsRequest eligibilityRequest = new DetermineEligibleCustomerInstructionsRequest();

        String candidateInstruction1 = "mnemonic 2";
        String candidateInstruction2 = "mnemonic 2";
    ...
    public DetermineEligibleCustomerInstructionsRequest eligibilityRequestForNormal() {
        DetermineEligibleCustomerInstructionsRequest eligibilityRequest = new DetermineEligibleCustomerInstructionsRequest();
    ...
    public F062Req convertWhenBfpoNotPresent(String arrangementType, Customer primaryInvolvedParty, RequestHeader header, String addressStrength, String identityStrength, boolean marketingPref) throws ParseException {
        F062RequestBuilder requestBuilder = new F062RequestBuilder();
        F062Req request = requestBuilder.defaults().build();
        if (null != primaryInvolvedParty.getCustomerIdentifier() && !"".equals(primaryInvolvedParty.getCustomerIdentifier())) {
            request.setPartyId(Long.valueOf(primaryInvolvedParty.getCustomerIdentifier()));
    ...
    public Applications createApplication() {


        Applications applications = new Applications(applicationTypes, productTypes, brands, userTypes, applicationStatus2, promotionChannels, channels, "10005");
        ...
        activityHistory.setApplicationStatus(applicationStatus1);
    ...
    public Individuals getIndividuals(Long partyId) {
        return individualsDao.findOne(partyId);
    }
    ...
    public void createAbandonDeclineReasons() {
        ...
        AbandonDeclineReasons declineReasons12 = new AbandonDeclineReasons("112", "SIRA decline");
        ...
        abandonDeclineReasonDao.save(declineReasons12);
    ...
    public DetermineEligibleCustomerInstructionsRequest createEligibilityRequestWhenBfpoNotPresentAndEligibilityIsTrue(OfferProductArrangementRequest request, RequestHeader requestHeader, boolean isBFPOIndicatorPresent) throws OfferProductArrangementInternalServiceErrorMsg, OfferProductArrangementDataNotAvailableErrorMsg {
        ...
        DetermineEligibleCustomerInstructionsRequest eligibilityRequest = offerToEligibilityRequestConverter.convertOfferToEligibilityRequest(request.getProductArrangement(), requestHeader, isBFPOIndicatorPresent);
...
*/
    ...
    public int getApplicationsParameterValueSize() {
        int count = 0;
        for (ApplicationParameterValues applicationParameterValues : applicationParameterValuesDao.findAll()) {
            count++;
        }
        return count;
    }

    public SubmitWorkItemResponse.SubmitWorkItemResult createubmitWorkItemResult(BigInteger totalRuleScore)
    {
    ...
    public List<ReferenceDataLookUp> createSiraThresholdValuesList()
    {
        ...
        referenceDataLookUp1.setLookupValueDesc("0");
        ReferenceDataLookUp referenceDataLookUp2=new ReferenceDataLookUp();
        referenceDataLookUp2.setLookupValueDesc("19");
        ReferenceDataLookUp referenceDataLookUp3=new ReferenceDataLookUp();
        referenceDataLookUp3.setLookupValueDesc("20");
        ReferenceDataLookUp referenceDataLookUp4=new ReferenceDataLookUp();
        referenceDataLookUp4.setLookupValueDesc("420");
        ReferenceDataLookUp referenceDataLookUp5=new ReferenceDataLookUp();
        referenceDataLookUp5.setLookupValueDesc("421");
        ReferenceDataLookUp referenceDataLookUp6=new ReferenceDataLookUp();
        referenceDataLookUp6.setLookupValueDesc("9900");
        ReferenceDataLookUp referenceDataLookUp7=new ReferenceDataLookUp();
        referenceDataLookUp7.setLookupValueDesc("9901");
        referenceDataLookUps.add(referenceDataLookUp1);
        referenceDataLookUps.add(referenceDataLookUp2);
        referenceDataLookUps.add(referenceDataLookUp3);
        referenceDataLookUps.add(referenceDataLookUp4);
        referenceDataLookUps.add(referenceDataLookUp5);
        referenceDataLookUps.add(referenceDataLookUp6);
        referenceDataLookUps.add(referenceDataLookUp7);
        return referenceDataLookUps;
    }



    public F336Resp createF336ResponseWithError() {
        F336Resp f336Resp = new F336Resp();
        ResultCondition resultCondition = new ResultCondition();
        resultCondition.setReasonCode(123);
        resultCondition.setReasonText("failure");
        resultCondition.setSeverityCode((byte)1);
        f336Resp.setF336Result(new F336Result());
        f336Resp.getF336Result().setResultCondition(resultCondition);
        return f336Resp;
    }

    public F061Resp createF061RespWithError() {
        F061Resp f061Resp = new F061Resp();
        F061Result f061Result = new F061Result();
        f061Result.setResultCondition(new ResultCondition());
        f061Result.getResultCondition().setReasonCode(160999);
        f061Result.getResultCondition().setReasonText("fail");
        f061Resp.setF061Result(f061Result);
        return f061Resp;
    }

    public F061Resp createF061RespWithImproperResponse() {
        F061Resp response = new F061Resp();
        response.setF061Result(new F061Result());
        response.getF061Result().setResultCondition(new ResultCondition());
        response.getF061Result().getResultCondition().setReasonCode(0);
        response.getF061Result().getResultCondition().setReasonText("reasonText");
        return response;
    }

    public F204Resp createF204ResponseWithExternalBusinessError() {
        F204Resp f204Resp = new F204Resp();
        f204Resp.setF204Result(new F204Result());
        f204Resp.getF204Result().setResultCondition(new ResultCondition());
        f204Resp.getF204Result().getResultCondition().setReasonCode(159179);
        return f204Resp;
    }

    public F204Resp createF204ResponseWithExternalServiceError() {
        F204Resp f204Resp = new F204Resp();
        f204Resp.setF204Result(new F204Result());
        f204Resp.getF204Result().setResultCondition(new ResultCondition());
        f204Resp.getF204Result().getResultCondition().setReasonCode(159259);
        return f204Resp;
    }

    public DetermineEligibleCustomerInstructionsResponse eligibilityResponseWithException(int exceptionType) {
        DetermineEligibleCustomerInstructionsResponse eligibilityResponse = new DetermineEligibleCustomerInstructionsResponse();
        //eligibilityResponse.getHeader
        return eligibilityResponse;
    }

    public F336Resp createF336ResponseWithEmptyAmdEffDt(int productOneGroupId, int productTwoGroupId) {
        F336Resp f336Resp = new F336Resp();
        f336Resp.setAdditionalDataIn(0);
        f336Resp.setF336Result(createF336Result());
        List<ProductPartyData> productPartyData = new ArrayList<>();
        ...
        productPartyData1.setProdGroupId(productOneGroupId);
        productPartyData1.setSellerLegalEntCd("LTB");
        productPartyData1.setAmdEffDt("  ");

        productPartyData1.setProductHeldOpenDt("05052015");
        ProductPartyData productPartyData2 = new ProductPartyData();
        productPartyData2.setProdGroupId(productTwoGroupId);
        productPartyData2.setSellerLegalEntCd("LTB");
        productPartyData2.setAmdEffDt("  ");
    ...
    public F061Resp createF061RespWithNoAddressLinePaf(int reasonCode) {
        ...
        response.getPartyEnqData().getAddressData().setAddressStatusCd("001");
        response.getPartyEnqData().getAddressData().setAddressTypeCd("001");
        response.getPartyEnqData().getAddressData().setAmdEffDt("");
        ...
        structuredAddress.setAddressCountyNm("London");
        structuredAddress.setDelivPointSuffixCd("1E");
        structuredAddress.getAddressLinePaf().clear();
