...
import com.lloydsbanking.salsa.opacc.client.OpaccClient;
import com.lloydsbanking.salsa.opacc.service.ScenarioHelper;
...
@ContextConfiguration(locations = {"classpath:/com/lloydsbanking/salsa/opacc/service/application-context-with-downstream-profiles.xml"})
public abstract class AbstractOpaccJBehaveTestBase extends JBehaveTestBase {
    @Autowired
    protected MockControlServicePortType mockControl;

    @Autowired
    protected OpaccClient opaccClient;
    ...
    public final void setUp() {
        ...
        mockControl.reset();
        scenarioNumber += 1;
        opaccClient.setSoapMessagesLogFilename(targetHostContainer + "/" + this.getClass().getSimpleName() + "-" + scenarioNumber + ".xml");
