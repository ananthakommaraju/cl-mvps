...
public class OpaccRequestHeaderBuilder {

    public static final String BAPI_HOST_PARTY_ID = "+00434307833          ";

    RequestHeader requestHeader;

    public OpaccRequestHeaderBuilder() {
        this.requestHeader = new RequestHeader();
    }

    public OpaccRequestHeaderBuilder interactionId(String interactionId) {
        requestHeader.setInteractionId(interactionId);
        return this;
    }

    public OpaccRequestHeaderBuilder channelId(String channelId) {
        requestHeader.setChannelId(channelId);
        return this;
    }

    public OpaccRequestHeaderBuilder businessTransaction(String businessTransaction) {
        requestHeader.setBusinessTransaction(businessTransaction);
        return this;
    }

    public OpaccRequestHeaderBuilder bapiInformation(String chanId, String interactionId, String ocisId, String prefix, String colleagueId, String ucId, String callerIpAddress) {
        ...
        bapiHeader.setCallerlineid(callerIpAddress);
        bapiHeader.setIpAddressCaller(callerIpAddress);
    ...
    public OpaccRequestHeaderBuilder bapiInformationUnAuth(String chanId, String interactionId, String ocisId, String prefix, String userIdAuthor) {
        BapiInformation bapiInfo = new BapiInformation();
        bapiInfo.setBAPIId("B001");
        ...
        BAPIHeader bapiHeader = new BAPIHeader();
        bapiHeader.setUseridAuthor(userIdAuthor);
    ...
    public OpaccRequestHeaderBuilder securityHeader(String prefix, String username) {
    ...
    public OpaccRequestHeaderBuilder serviceRequest(String prefix, String businessTransaction, String from, String messageId) {
    ...
    public OpaccRequestHeaderBuilder contactPoint(String prefix, String contactPointType, String contactPointId, String applicationId, String initialOriginatorType, String initialOriginatorId, String operatorType) {
