...
public class OpaSavingRequestHeaderBuilder {
    public static final String BAPI_HOST_PARTY_ID = "+00434307833";


    RequestHeader requestHeader;

    public OpaSavingRequestHeaderBuilder() {
        this.requestHeader = new RequestHeader();
    }

    public OpaSavingRequestHeaderBuilder interactionId(String interactionId) {
        requestHeader.setInteractionId(interactionId);
        return this;
    }

    public OpaSavingRequestHeaderBuilder channelId(String channelId) {
        requestHeader.setChannelId(channelId);
        return this;
    }

    public OpaSavingRequestHeaderBuilder businessTransaction(String businessTransaction) {
        requestHeader.setBusinessTransaction(businessTransaction);
        return this;
    }

    public OpaSavingRequestHeaderBuilder bapiInformation(String chanId, String interactionId, String ocisId, String prefix, String colleagueId, String ucId) {
    ...
    public OpaSavingRequestHeaderBuilder securityHeader(String prefix, String username) {
    ...
    public OpaSavingRequestHeaderBuilder serviceRequest(String prefix, String businessTransaction, String from, String messageId) {
    ...
    public OpaSavingRequestHeaderBuilder contactPoint(String prefix, String contactPointType, String contactPointId, String applicationId, String initialOriginatorType, String initialOriginatorId, String operatorType) {
