package com.lloydsbanking.salsa.apaloans.logging;
...
public class ApaLoansLogServiceTest {
    ApaLoansLogService apaLoansLogService;

    @Before
    public void setUp() {
        apaLoansLogService = new ApaLoansLogService();
    }
    ...
    public void testInitialiseContext() throws Exception {
        ...
        apaLoansLogService.cloneName = "TestClone";

        MockHttpServletRequest servletRequest = new MockHttpServletRequest();
        servletRequest.setLocalAddr("1.2.3.4");
        servletRequest.setRemoteAddr("5.6.7.8");

        apaLoansLogService.initialiseContext(requestHeader);
        ...
        assertEquals("Salsa APA LOANS", MDC.get(LogItem.APPLICATION.name()));
    }
}