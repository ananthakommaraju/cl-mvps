...
public class F241PostalAddressFactoryTest {
    ...
    @Before
    public void setUp() {
        f241PostalAddressFactory = new F241PostalAddressFactory();
    ...
    @Test
    public void testStructureAddressWhenBuildingNumberIsNull() {
        financeServiceArrangement.getPrimaryInvolvedParty().getPostalAddress().get(0).getStructuredAddress().setSubBuilding("sub");
