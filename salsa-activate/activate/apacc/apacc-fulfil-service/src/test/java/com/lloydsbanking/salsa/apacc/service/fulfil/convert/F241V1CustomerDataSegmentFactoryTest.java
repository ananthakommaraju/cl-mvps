...
import com.lloydsbanking.salsa.soap.fdi.f241V1.objects.CustomerDataSegment;
...
public class F241V1CustomerDataSegmentFactoryTest {
    F241V1CustomerDataSegmentFactory f241CustomerDataSegmentFactory;
    TestDataHelper testDataHelper;
    FinanceServiceArrangement financeServiceArrangement;

    @Before
    public void setUp() {
        f241CustomerDataSegmentFactory = new F241V1CustomerDataSegmentFactory();
        testDataHelper = new TestDataHelper();
        financeServiceArrangement= testDataHelper.createFinanceServiceArrangement();
       f241CustomerDataSegmentFactory.f241PhoneNumberFactory = new F241V1PhoneNumberFactory();
        f241CustomerDataSegmentFactory.f241PostalAddressFactory = new F241V1PostalAddressFactory();
    }
