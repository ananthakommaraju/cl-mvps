...
import com.lloydsbanking.salsa.soap.fdi.f241V1.objects.CoOwnerMarketingChannels;
import com.lloydsbanking.salsa.soap.fdi.f241V1.objects.MarketingDataSegment;
import com.lloydsbanking.salsa.soap.fdi.f241V1.objects.OwnerMarketingChannels;
import com.lloydsbanking.salsa.soap.fdi.f241V1.objects.OwnerMarketingProducts;
import lib_sim_bo.businessobjects.Customer;
import lib_sim_bo.businessobjects.FinanceServiceArrangement;
import org.springframework.stereotype.Component;

@Component
public class F241V1MarketingDataSegmentFactory {
    ...
    public MarketingDataSegment getMarketingDataSegment(FinanceServiceArrangement financeServiceArrangement) {
        ...
        marketingDataSegment.setOwnerMarketingProducts(getOwnerMarketingProduct());
    ...
    private OwnerMarketingChannels getOwnerMarketingChannels(FinanceServiceArrangement financeServiceArrangement) {
        ...
        if (customer.getCustomerNumber() != null) {
            if (financeServiceArrangement.isMarketingPreferenceByMail() != null && financeServiceArrangement.isMarketingPreferenceByMail()) {
                ownerMarketingChannels.setMailMktIn("1");
            } else {
                ownerMarketingChannels.setMailMktIn("0");
            }
            if (financeServiceArrangement.isMarketingPreferenceByPhone() != null && financeServiceArrangement.isMarketingPreferenceByPhone()) {
                ownerMarketingChannels.setPhoneMktIn("1");
            } else {
                ownerMarketingChannels.setPhoneMktIn("0");
            }
            if (financeServiceArrangement.isMarketingPreferenceByEmail() != null && financeServiceArrangement.isMarketingPreferenceByEmail()) {
                ownerMarketingChannels.setEmailAddressIn("1");
            } else {
                ownerMarketingChannels.setEmailAddressIn("0");
            }
            if (financeServiceArrangement.isMarketingPreferenceBySMS() != null && financeServiceArrangement.isMarketingPreferenceBySMS()) {
    ...
    private OwnerMarketingProducts getOwnerMarketingProduct() {
        OwnerMarketingProducts ownerMarketingProducts = new OwnerMarketingProducts();
