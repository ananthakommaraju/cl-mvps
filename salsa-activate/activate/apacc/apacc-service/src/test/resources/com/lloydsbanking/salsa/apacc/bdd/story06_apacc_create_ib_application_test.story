...
Scenario: 1. APACC calls B750 when Application is not eligible for fulfilment and eligible for IB registration
...
Scenario: 2. APACC continues if Application is eligible for fulfilment
...
Scenario:3. APACC throws internal service error if application type is not valid
