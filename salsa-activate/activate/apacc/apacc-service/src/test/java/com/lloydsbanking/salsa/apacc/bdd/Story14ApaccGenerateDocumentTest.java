...
public class Story14ApaccGenerateDocumentTest extends AbstractApaccJBehaveTestBase {
    ...
    public void givenGenerateDocumentFails() throws RetrieveProductConditionsDataNotAvailableErrorMsg, RetrieveProductConditionsExternalBusinessErrorMsg, RetrieveProductConditionsResourceNotAvailableErrorMsg, RetrieveProductConditionsExternalServiceErrorMsg, RetrieveProductConditionsInternalServiceErrorMsg, ActivateProductArrangementDataNotAvailableErrorMsg, ActivateProductArrangementResourceNotAvailableErrorMsg, ActivateProductArrangementInternalSystemErrorMsg {
        String channelId = mockScenarioHelper.expectChannelIdByContactPointID();
        mockScenarioHelper.expectReferenceDataForPAM();
        mockScenarioHelper.expectLookUpValues();
        KycStatus eidvStatus = new KycStatus("ACCEPT");
    ...
    public void thenSetIsStoreApplicationAndIsTradeApplicationFlagAndServiceContinues() {
        assertNotNull(response);
        mockScenarioHelper.verifyExpectCalls();
    }

    @Then("assign Application SubStatus as ACQUIRE_CALL_FAILURE")
    public void thenAssignApplicationSubStatusAsACQUIRE_CALL_FAILURE() {
        assertNotNull(response);
        mockScenarioHelper.verifyExpectCalls();
    }
