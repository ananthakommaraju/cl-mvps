...
public class Story09ApaccFetchesLookupValuesBasedOnGroupCodeTest extends AbstractApaccJBehaveTestBase {
    ...
    public void givenThereIsAInternalCallToRetrieveLookUpValuesWhereInvokeParameterIsGroupCodeIsNotValid() {
        mockScenarioHelper.expectLookUpValuesForInvalidEvidenceAndPurposeData();
    }

    @When("there is a call for APACC")
    public void whenThereIsACallForAPACC() throws ActivateProductArrangementInternalSystemErrorMsg, ActivateProductArrangementExternalBusinessErrorMsg, ActivateProductArrangementExternalSystemErrorMsg, ActivateProductArrangementResourceNotAvailableErrorMsg {
        mockControl.go();
        try {
