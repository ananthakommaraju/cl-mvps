...
public class Story04ApaccValidatesAppStatusTest extends AbstractApaccJBehaveTestBase {
    ...
    public void givenApplicationStatusAndSourceSystemIdentifierIsInvalid() {
    ...
    public void whenThereIsACallToAPACC() throws ActivateProductArrangementExternalBusinessErrorMsg, ActivateProductArrangementExternalSystemErrorMsg, ActivateProductArrangementResourceNotAvailableErrorMsg, ActivateProductArrangementDataNotAvailableErrorMsg {
        mockControl.go();
        try {
