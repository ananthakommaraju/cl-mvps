...
public class ApaCcLogServiceTest {
    ApaCcLogService apaCcLogService;

    @Before
    public void setUp() {
        apaCcLogService = new ApaCcLogService();
    }
    ...
    public void testInitialiseContext() throws Exception {
        ...
        assertEquals("Salsa APA CC", MDC.get(LogItem.APPLICATION.name()));
    }
}