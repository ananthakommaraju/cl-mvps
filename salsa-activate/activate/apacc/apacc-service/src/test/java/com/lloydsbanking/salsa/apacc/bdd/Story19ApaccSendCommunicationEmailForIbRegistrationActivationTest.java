...
public class Story19ApaccSendCommunicationEmailForIbRegistrationActivationTest extends AbstractApaccJBehaveTestBase {
    ...
    @Given("user access level is lite")
    public void givenUserAccessLevelIsLite() throws SendCommunicationResourceNotAvailableErrorMsg, SendCommunicationExternalServiceErrorMsg, SendCommunicationExternalBusinessErrorMsg, SendCommunicationDataNotAvailableErrorMsg, SendCommunicationInternalServiceErrorMsg {
    ...
    @Given("user access level is ultra lite")
    public void givenUserAccessLevelIsUltraLite() throws SendCommunicationResourceNotAvailableErrorMsg, SendCommunicationExternalServiceErrorMsg, SendCommunicationExternalBusinessErrorMsg, SendCommunicationDataNotAvailableErrorMsg, SendCommunicationInternalServiceErrorMsg {
    ...
    public void thenSendCommunicationForSuccessfulRegistrationWithTemplateIB_STP_LITE_REGISTRATION_SUCCESS_MAIL() {
    ...
    public void thenSendCommunicationForSuccessfulRegistrationWithTemplateIB_STP_REGISTRATION_SUCCESS_MAIL() {
        assertNotNull(response);
        mockScenarioHelper.verifyExpectCalls();
    }
