...
public class Story20ApapcaUpdateNationalInsuranceNumberTest extends AbstractApapcaJBehaveTestBase {
    ...
    @Then("call OCIS API C234 to update national insurance number.")
    public void thenCallOCISAPIC234ToUpdateNationalInsuranceNumber() {
