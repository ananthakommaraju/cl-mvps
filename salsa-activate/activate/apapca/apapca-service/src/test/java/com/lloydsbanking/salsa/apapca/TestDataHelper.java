...
import com.lloydsbanking.salsa.commsmanager.ref.model.CommunicationTemplateElement;
import com.lloydsbanking.salsa.commsmanager.ref.model.RefDataLookup;
import com.lloydsbanking.salsa.commsmanager.ref.model.RefDataLookupId;
...
public class TestDataHelper {
    ...
    public static final String TEST_EMAIL_TEMPLATE = "CA_WELCOME_MSG";

    public static final String TEST_EMAIL_BENEFIT_TEMPLATE = "CA_BENEFITS_MSG";
    ...
    ApplicationParameters applicationParameters62 = new ApplicationParameters("100063", parameterGroups10, "SIRA Total Rule Score");
    ApplicationParameters applicationParameters63 = new ApplicationParameters("100062", parameterGroups9, "SIRA Result Status");
    ...
    public void createPamReferenceData() {
        ...
        applicationParametersDao.save(applicationParameters62);
        applicationParametersDao.save(applicationParameters63);
    ...
    public void setSwitchingDetailsInRequest(DirectDebit accountSwitchingDetails) {
        accountSwitchingDetails.setAccountHolderName("ABC");
        accountSwitchingDetails.setAccountNumber("74885074");
        accountSwitchingDetails.setConsent("True");
        accountSwitchingDetails.setOverdraftHeldIndicator("True");
        accountSwitchingDetails.setSortCode("402715");
        accountSwitchingDetails.setTextAlert("True");
        ...
        accountSwitchingDetails.setSwitchDate(date);
    }

    public List<TelephoneNumber> createTelephoneNumber() {
        TelephoneNumber telephoneNumber = new TelephoneNumber();
        telephoneNumber.setCountryPhoneCode("44");
        telephoneNumber.setPhoneNumber("7440696125");
        telephoneNumber.setTelephoneType("7");
