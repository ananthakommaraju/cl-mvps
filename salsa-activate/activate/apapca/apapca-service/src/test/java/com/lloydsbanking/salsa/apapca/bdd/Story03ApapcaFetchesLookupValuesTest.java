...
public class Story03ApapcaFetchesLookupValuesTest extends AbstractApapcaJBehaveTestBase {
    ...
    public void givenSortCodeIsPresentInRequest() throws ErrorInfo, SendCommunicationResourceNotAvailableErrorMsg, SendCommunicationExternalServiceErrorMsg, SendCommunicationExternalBusinessErrorMsg, SendCommunicationDataNotAvailableErrorMsg, SendCommunicationInternalServiceErrorMsg {
    ...
    public void whenThereIsACallToAPADWhenSortCodePresent() {
        mockControl.go();
        try {
    ...
    public void givenPAMDoesNotContainLookupValuesForEncryptionKeyAndPurposeOfAccount() throws RetrieveProductConditionsDataNotAvailableErrorMsg, RetrieveProductConditionsExternalBusinessErrorMsg, RetrieveProductConditionsResourceNotAvailableErrorMsg, RetrieveProductConditionsExternalServiceErrorMsg, RetrieveProductConditionsInternalServiceErrorMsg {
        request = testDataHelper.createApaRequestForPca(1L);
        ...
        mockScenarioHelper.expectLookUpValuesWithISOCode();
        mockScenarioHelper.expectE226AddsOverdraftDetail(1L, request.getProductArrangement().getFinancialInstitution().getChannel(), request.getHeader());
    ...
    public void thenServiceThrowsError() {
        ...
        // assertEquals("No matching records found, error code:", dataNotAvailableErrorMsg.getFaultInfo().getDescription());
    }
