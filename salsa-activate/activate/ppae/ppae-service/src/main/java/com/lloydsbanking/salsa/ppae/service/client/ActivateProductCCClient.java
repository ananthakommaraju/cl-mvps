...
public class ActivateProductCCClient {
    private static final Logger LOGGER = Logger.getLogger(ActivateProductCCClient.class);
    IAActivateProductArrangement port;

    CxfClientLoggingInitialiser loggingInitialiser;


    public ActivateProductCCClient(URL url, CxfClientLoggingInitialiser loggingInitialiser) {
