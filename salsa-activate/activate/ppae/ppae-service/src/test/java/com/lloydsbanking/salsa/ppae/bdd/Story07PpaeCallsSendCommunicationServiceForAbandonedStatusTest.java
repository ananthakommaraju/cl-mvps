...
public class Story07PpaeCallsSendCommunicationServiceForAbandonedStatusTest extends AbstractPpaeJBehaveTestBase {

    ProcessPendingArrangementEventRequest request;

    ApplicationStatus applicationStatus = new ApplicationStatus("1011", "ABANDONED");
    ...
    public void ApplicationStatusIsAbandonedinRequest() throws DataNotAvailableErrorMsg, ResourceNotAvailableErrorMsg, SendCommunicationResourceNotAvailableErrorMsg, SendCommunicationExternalServiceErrorMsg, SendCommunicationExternalBusinessErrorMsg, SendCommunicationDataNotAvailableErrorMsg, SendCommunicationInternalServiceErrorMsg {
        ...
        mockScenarioHelper.expectSendCommunicationCall(productArrangement, "CA_APPL_ABANDONED_MSG", request.getHeader(), null, ActivateCommonConstant.CommunicationTypes.EMAIL);
