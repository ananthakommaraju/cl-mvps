...
import com.lloydsbanking.xml.schema.enterprise.informationtechnology.esb.ifwxml.ResponseHeader;
...
public class TestDataHelper {
    ...
    public static final String TEST_EMAIL_TEMPLATE = "SA_WELCOME_MSG";
    ...
    ApplicationParameters applicationParameters13 = new ApplicationParameters("100056", parameterGroups1, "Linking Failure");
...
/*        TelephoneAddresses telephoneAddresses = new TelephoneAddresses();
    ...
    public E032Resp createE032Resp(byte severityCode) {
        ...
        e032Resp.getE032Result().getResultCondition().setReasonText("external Service rerror");
        return e032Resp;
    }
