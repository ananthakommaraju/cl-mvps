...
public class Story23ApasaChecksEidvStatusAndSetsFulfilEligibleFlagTest extends AbstractApasaJBehaveTestBase {
    ...
    public void givenEidvStatusIsRefer() throws ActivateProductArrangementDataNotAvailableErrorMsg, ActivateProductArrangementResourceNotAvailableErrorMsg, SendCommunicationResourceNotAvailableErrorMsg, SendCommunicationExternalServiceErrorMsg, SendCommunicationExternalBusinessErrorMsg, SendCommunicationDataNotAvailableErrorMsg, SendCommunicationInternalServiceErrorMsg, ActivateProductArrangementInternalSystemErrorMsg {
        ...
        mockScenarioHelper.expectLookUpValuesWithISOCode();
        mockScenarioHelper.expectSendCommunicationCall(productArrangement, "SA_REFERTOBRANCH_MSG", request.getHeader(),null,"Email", true);

    }

    @When("there is call to APASA")
    public void whenThereIsCallToAPASA() throws ActivateProductArrangementInternalSystemErrorMsg, ActivateProductArrangementExternalBusinessErrorMsg, ActivateProductArrangementExternalSystemErrorMsg, ActivateProductArrangementResourceNotAvailableErrorMsg, ActivateProductArrangementDataNotAvailableErrorMsg {
        mockControl.go();
    ...
    public void thenSetFulfilmentEligibilityFlagAsTrueAndServiceContinues() {
        assertNotNull(response);
        mockScenarioHelper.verifyExpectCalls();
    }
