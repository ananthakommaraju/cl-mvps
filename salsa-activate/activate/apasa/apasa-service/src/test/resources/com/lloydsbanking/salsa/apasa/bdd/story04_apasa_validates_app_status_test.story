...
Scenario: 1. APASA continues for a Valid DB event Request
...
Scenario: 2. APASA throws error if request is not valid
Given Application status and Source system Identifier is invalid
When there is a call to APAD
Then service throws error

Scenario: 3. APASA continues for a Valid Galaxy Online Request
